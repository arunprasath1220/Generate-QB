          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              >
                ...
                <span className="font-medium text-purple-800">Manage Faculty</span>
              </button>
              ...
              >
                ...
                <span className="font-medium text-purple-800">Assign Tasks</span>
              </button>
              ...
              >
                ...
                <span className="font-medium text-purple-800">Vetting Tasks</span>
              </button>
            </div>
          </div>
        </div>
